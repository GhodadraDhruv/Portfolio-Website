            ...
            <section class="home bd-grid hm" id="home">
                ...
                <div class="home__img pf">
                    <svg class="home__blob" viewBox="0 0 479 467" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                        ...
                        <g>                            
                            <image class="home__blob-img" href="<?php echo e(url('img/profile-mod.png')); ?>"/>
                        </g>
                    </svg>
                </div>
            </section>
            ...
            <section class="about section " id="about">
                ...
                <div class="about__container bd-grid">
                    <div class="about__img">
                        <img src="<?php echo e(url('img/profile.png')); ?>" alt="">
                    </div>
                    
                    <div>
                        <h2 class="about__subtitle">I am Dhruv</h2>
                        <p class="about__text">A passionate Web Designer based in Gujarat. With a background in Computer Science, I enjoy exploring watching movie,
...
<?php /**PATH D:\MCA\Laravel\portfolio-website\resources\views/home.blade.php ENDPATH**/ ?>