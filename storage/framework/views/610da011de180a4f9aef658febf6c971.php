     ...
     <nav class="nav bd-grid">
         ...
         <div class="nav__menu" id="nav-menu">
             <ul class="nav__list">
                 ...
                 <li class="nav__item"><a href="/contact" class="text-white">Conatct</a></li>
             </ul>
         </div>
            ...
            <section class="contact section" id="contact">
                ...
                <div class="contact__container bd-grid">
                    <form action="" class="contact__form">
                        ...
                        <textarea name="" id="" cols="0" placeholder="Message" rows="10" class="contact__input"></textarea>
...
<?php /**PATH D:\MCA\Laravel\portfolio-website\resources\views/contact.blade.php ENDPATH**/ ?>